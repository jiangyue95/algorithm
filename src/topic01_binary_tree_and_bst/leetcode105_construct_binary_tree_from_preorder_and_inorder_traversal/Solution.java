package topic01_binary_tree_and_bst.leetcode105_construct_binary_tree_from_preorder_and_inorder_traversal;
...
public class Solution {
    ...
    // This HashMap is used to avoid loop search and decrease the time 
    // complexity
    ...
    public TreeNode buildTree(int[] preorder, int[] inorder) {
        ...
        // use preorder and inorder sequencees construct binary tree
    ...
    private TreeNode build(int[] preorder,
        ...
        // The root node should be the first element of the preorder traversal
        // array
        ...
        // The key point is to determine the boundary of preorder traversal 
        // array
        root.left = build(
            preorder, 
            preStart + 1, 
