package topic01_binary_tree_and_bst.leetcode106_construct_binary_tree_from_inorder_and_postorder_traversal;
...
public class Solution {
    ...
    public TreeNode buildTree(int[] inorder, int[] postorder) {
        ...
        // put the value of inorder into the hashmap
     ...
     * 
     * defined by the inorder traversal array and the postorder traversal array
     * Return the root node of the binary tree
     * two key definition: 
     * inorder[inStart..inEnd], 
     * postorder[postStart..postEnd]
     * Assume that the inorder traversal array inorder begain with inStart and 
     * end with inEnd.
     * and the postorder traversal array postorder begin with postStart and 
     * end with postEnd.
     * 
     * @param inorder inorder traversal array
    ...
    private TreeNode build(
        ...
        // the value the root node is the last element of postorder traversal
        //  array
